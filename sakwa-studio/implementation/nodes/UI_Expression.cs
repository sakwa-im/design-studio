...
namespace sakwa
{
    public class UI_Expression : IExpressionImpl, ICustomTypeDescriptor
    {
        public UI_Expression() : base()
        {
            CategoriesToShow.AddRange(new string[] 
            { "Global settings", "Expression", "Variable selection", "Value selection" });
        ...
        {
            UI_Expression result = new UI_Expression();
            result.Tree = Tree;
        ...
        {
            string result = UI_Constants.AssignmentLabel(this);
            return result != "" ? result : _Name;

        }


        [CategoryAttribute("Global settings"), Editor(typeof(MultiLineTextEditor), typeof(UITypeEditor))]
        ...
        [Description("Expresion that is executed by this node")]
        public string Expression
        {
            get { return _Expression; }
            set
            {
                IExpressionInterface.Expression = value;
            }
        }
        #endregion
        ...
        [DisplayName("Value")]
        [Description("This is the value that is assigned to the variable")]
        public string Value
        {
