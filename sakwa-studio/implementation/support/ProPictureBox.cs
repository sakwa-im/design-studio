...
{
    public ModelEventArgs(int x, int y) : base()
    {
        X = x;
        Y = y;
    }
    public ModelEventArgs(Point location) : base()
    {
        X = location.X;
        Y = location.Y;
    }
...
public delegate void ModelLocation(object sender, ModelEventArgs e);
...
public class ProPictureBox : PictureBox
{
    ...
    {
        _transformation = new ProTransformation(new Point(0, 0), 5f);
    ...
    public event ModelLocation ModelLocationUpdate;

    private void OnModelLocation()
    {
        if (ModelLocationUpdate != null)
            ModelLocationUpdate(this, new global::ModelEventArgs(_clickedPoint.Value));
    }
    ...
    public new Image Image
    {
        ...
        set
        {
            ...
            //    _transformation = new ProTransformation(new Point(0, 0), Convert.ToDouble(maxScale));
            //}
        }
    }
    ...
    {
        if (_clickedPoint == null || Image == null)
            return;
