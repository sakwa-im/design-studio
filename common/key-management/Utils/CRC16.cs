...
namespace kms
{
    public class CRC16
    {
        ...
        public static ushort compute_fcs(byte[] data)
        {
            return compute_fcs(data, 0, data.Length);
        }
        public static ushort compute_fcs(byte[] data, int start, int length)
        {
            ushort fcs = 0xFFFF;
        ...
        public static ushort compute_fcs(byte[] data, ushort seed = 0xFFFF)
        {
            return compute_fcs(data, 0, data.Length, seed);
        }
        public static ushort compute_fcs(byte[] data, int start, int length, ushort seed = 0xFFFF)
        {
            ushort fcs = seed;
            int end = start + length;
